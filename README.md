# Agora Web Interactive Live Streaming - Webpack

This tutorial shows you how to quickly integrate Agora Web Live Streaming SDK with the Agora sample app.
...
3. Your default browser should open and display the sample application, as shown here.
    **Note:** In some cases, you may need to open a browser and enter `http://localhost:5005` as the URL.
